...
GREY = "#787c7e"
OUTLINE = "#c4c3d0"
FILLED_OUTLINE = "#d8bfd8"

words_for_guess =["apple", "brave", "charm", "dance","demon", "eagle", "flame", "grape", "happy", "ivory", "joker", "karma", "lemon", "melon", "noble", "ocean", "pearl", "queen", "raven", "sugar", "tiger", "urban", "vivid", "witty", "xerox", "yield", "zebra"]
        ...
        if event.type == pygame.KEYDOWN:
            if event.key == pygame.K_RETURN:
                if result != "":
                    ...
                    if len(curr_guess_str) == 5 and (curr_guess_str.upper() or curr_guess_str.lower()) in WORDS:
